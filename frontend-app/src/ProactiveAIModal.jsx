...
6. Output Format: Return ONLY a valid JSON array. DO NOT use markdown formatting blocks (\`\`\`json).
...
[
  {
    ...
    "description": "Highly detailed and comprehensive brief expanding on the user's request. Provide full context, background, and specific requirements in markdown format. DO NOT include @ or # routing tags here.",
