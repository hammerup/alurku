        ...
        <>
          ...
          {currentTab === 'home' && (
            <div className="relative z-0 w-full flex flex-col items-center overflow-hidden bg-[#f8f9ff]">
              ...
              <div className="absolute top-150 left-10 w-100 h-100 bg-[#dce9ff] rounded-full opacity-50 blur-[100px] pointer-events-none -z-10" />
              <div className="absolute top-350 right-10 w-125 h-125 bg-[#d3e4fe] rounded-full opacity-50 blur-[120px] pointer-events-none -z-10" />
              <div className="absolute top-[2200px] left-5 w-112.5 h-112.5 bg-[#e5eeff] rounded-full opacity-45 blur-[110px] pointer-events-none -z-10" />
              <div className="absolute top-[3200px] right-20 w-100 h-100 bg-[#dce9ff] rounded-full opacity-40 blur-[120px] pointer-events-none -z-10" />
              <LandingHero
                setIsLoginMode={setIsLoginMode}
                setShowAuthForm={setShowAuthForm}
                isInstallable={isInstallable}
