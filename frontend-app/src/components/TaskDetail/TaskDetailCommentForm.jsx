          ...
          {replyingTo && (
            <div className="mb-3 flex items-start justify-between bg-indigo-50/50 dark:bg-indigo-900/20 rounded-xl p-2.5 border border-indigo-100 dark:border-indigo-800/50">
              ...
              <button
                ...
                className="text-neutral-400 hover:text-black dark:hover:text-white p-1 rounded-md hover:bg-black/5 dark:hover:bg-white/5 transition-colors cursor-pointer"
                title={tMsg ? tMsg('Cancel reply', 'Batal membalas') : 'Cancel reply'}
              >
