  ...
  return (
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10 text-center reveal-on-scroll">
            <h2 className="text-4xl md:text-5xl font-black text-[#111E38] mb-6 tracking-tighter">
            ...
            <button
              ...
              className="w-full sm:w-auto bg-[#FACC15] hover:bg-[#F5C200] text-[#111E38] font-extrabold py-4 px-10 rounded-full shadow-2xl transition-all hover:-translate-y-1 flex items-center justify-center gap-2 mx-auto tracking-wide text-sm sm:text-base border border-[#EAB308]"
            >
