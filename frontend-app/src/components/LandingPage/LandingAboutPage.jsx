          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="text-lg text-slate-300 dark:text-slate-350 space-y-6 leading-relaxed font-medium">
                <p>
                  {t(
                    "Hello! I am Eka Hary, the founder of alurku. Like many of you, I have struggled to keep daily tasks organized and stay productive without sacrificing my peace of mind. I realized that productivity shouldn't be about working ourselves to exhaustion, but about flowing with structure. That is why I built alurku. — a workload-aware assistant designed to balance your daily load, protect your team from burnout, and bring clarity to your execution.",
                    "Halo! Saya Eka Hary, founder dari alurku. Seperti kebanyakan orang, saya juga pernah berjuang keras mengatur tugas harian agar tetap produktif tanpa harus mengorbankan ketenangan pikiran. Saya menyadari bahwa produktivitas seharusnya bukan tentang memaksa diri kita bekerja hingga kelelahan, melainkan tentang mengalir secara teratur. Itulah mengapa saya membangun alurku. — asisten cerdas berbasis beban kerja yang dirancang untuk menyeimbangkan beban harian Anda, melindungi tim dari burnout, dan menghadirkan kejelasan alur kerja."
                  )}
                </p>
                <p>
                  {t(
