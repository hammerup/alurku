          ...
          <div className="px-4 py-2 border-b border-neutral-200/50 dark:border-neutral-800/50 shrink-0 relative bg-white/20 dark:bg-neutral-950/20">
            <div className="flex items-center justify-between gap-1.5 tour-quick-actions">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[8px] font-black px-1.5 py-0.5 rounded-full scale-90 min-w-4 text-center leading-none">
                    {unreadCount}
                  </span>
                )}
              </button>
            ...
            {/* Floating notification panel in expanded mode */}
            {isNotifOpen && (
              <>
                <div className="fixed inset-0 z-40" onClick={() => setIsNotifOpen(false)}></div>
                <div 
                  className="absolute bg-white dark:bg-neutral-900 border border-neutral-200/50 dark:border-neutral-800/50 rounded-2xl shadow-2xl z-50 flex flex-col max-h-112.5 overflow-hidden animate-fadeIn"
                  style={{
                    top: '45px',
                    left: '10px',
                    width: '320px',
