...
export default function AnalyticsView({
 ...
 <h2 className="overview-title text-xl font-bold text-slate-800 dark:text-white">
 ...
 />
 <path
 className={projectHealth >= 80 ? 'text-emerald-500' : projectHealth >= 50 ? 'text-[#FACC15]' : 'text-red-500'}
 ...
 {u.done}h <span className="opacity-50 font-medium">Delivered</span>
 </span>
 </div>
 ))
 )}
