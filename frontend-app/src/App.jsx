    ...
    `}</style>
      ...
      >
        ...
        {showTosUpdate && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-90 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-3xl p-6 md:p-10 max-w-lg w-full shadow-2xl mac-animate text-center">
              <div className="w-16 h-16 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner border border-indigo-100 dark:border-indigo-800/50">
        ...
        <div className={`flex-1 flex flex-col min-w-0 relative transition-all duration-300 ${
          ...
          (selectedBoard && viewMode === 'kanban') || (typeof currentPath === 'string' && currentPath.endsWith('/chat')) ? 'h-full min-h-0 overflow-hidden' : ''
        }`}>
