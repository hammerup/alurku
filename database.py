        ...
        if not existing_articles:
            default_articles = [
                # ID Articles
                {
                    ...
                    "content": "<p>Memulai proyek pertama di <strong>alurku.</strong> sangat mudah. Ikuti langkah-langkah di bawah ini untuk membuat ruang kerja yang teratur:</p><h2>1. Masuk ke Dashboard</h2><p>Buka halaman utama aplikasi dan pastikan Anda sudah masuk menggunakan akun Google Anda.</p><h2>2. Klik Tombol 'Proyek Baru'</h2><p>Di bilah sisi (sidebar) atau dasbor utama, klik tombol <strong>+ Proyek Baru</strong>.</p><h2>3. Tentukan Nama & Tipe Proyek</h2><p>Masukkan nama proyek yang Anda inginkan (misalnya 'Desain Ulang Website'). Pilih tipe proyek: <strong>Proyek Tim</strong> untuk kolaborasi dengan rekan kerja, atau <strong>Proyek Pribadi</strong> jika proyek ini hanya untuk Anda pantau sendiri.</p><h2>4. Atur Kolom Kanban</h2><p>Proyek baru akan langsung dibuat dengan kolom alur kerja bawaan (To Do, In Progress, Done). Anda dapat langsung mulai membuat tugas pertama Anda!</p>",
                    "language": "id"
                },
                {
